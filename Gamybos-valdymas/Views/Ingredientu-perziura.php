...
<head>
    ...
    <title>Ingredientų peržiūra</title>
    <style>
        html,
        body {
            height: 100%;
...
<body>
    ...
    <h3 class="header">Ingredientų peržiūra</h3>
    ...
    <div class="container">
        <ul class="list-unstyled">
            ...
            <li><a href="Ingredientu-salinimas-pasirinkimas.php" class="btn btn-warning funkcijos">Ingredientų šalinimas</a></li>
        </ul>
    </div>
