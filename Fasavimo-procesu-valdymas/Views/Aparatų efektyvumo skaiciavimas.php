...
<head>
    ...
    <title>Aparatu efektyvumo skaiciavimas</title>
    <style>
        html,
        body {
            height: 100%;
...
<body>
    ...
    <h3 class="header">Aparatu efektyvumo skaiciuokle</h3>
        ...
        <table class="table">
            <thead class="thead-dark">
                <tr>
                    ...
                    <th scope="col">Nasumas</th><th scope="col">Aparato id</th>
                </tr>
            </thead>
            <tbody>
                <?php
                foreach($aparatai as $ad)
                {
                    ...
                    echo $ad->id_Aparatas;
                    echo "</td><td>";
                    echo ("<a href=\"aparatu-skaiciuokle.php?id_Aparatas=".$ad->id_Aparatas."\">Skaiciuoti</a> ");
                    echo "</td></tr>";
                }
                ?>
            </tbody>
